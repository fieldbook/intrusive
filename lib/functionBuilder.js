...
var FunctionBuilder = module.exports = BaseObject.extend({
  ...
  wrap: function (originalFn, wrapperFn) {
    return function () {
      ...
      return applyFn(wrapperFn, this, [originalFn].concat(args)); // jscs: nestedThisOk
    }
  },
  ...
  after: function (originalFn, afterFn) {
    return function () {
      ...
      applyFn(afterFn, this, arguments); // jscs: nestedThisOk
      return result;
    }
  },
  ...
  before: function (originalFn, beforeFn) {
    return function () {
      applyFn(beforeFn, this, arguments); // jscs: nestedThisOk
